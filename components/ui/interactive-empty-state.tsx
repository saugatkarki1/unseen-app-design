...
const IconContainer = memo(
    ({ children, variant, className = "", theme = "light" }: IconContainerProps) => (
        <motion.div
...
const MultiIconDisplay = memo(({ icons, theme = "light" }: MultiIconDisplayProps) => {
...
export const EmptyState = forwardRef<HTMLElement, EmptyStateProps>(
    (
        ...
        const getVariantClasses = (v: Variant, t: Theme) => {
        ...
        const getTextClasses = (type: "title" | "description", s: Size, t: Theme) => {
            const sizes: Record<"title" | "description", Record<Size, string>> = {
                title: {
                    sm: "text-base",
                    default: "text-lg",
                    lg: "text-xl",
        ...
        const getButtonClasses = (s: Size, t: Theme) => {
            const sizeClasses: Record<Size, string> = {
